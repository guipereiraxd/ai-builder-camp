...
3. Me avise se encontrar problemas nos dados (valores nulos, inconsistências, etc.)`}</Prompt>
      ...
      <div className="mt-6 flex justify-between">
        ...
        <Link href="/exercises/2-4" className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors">
