...
Para cada canal, adapte: tom, formato, regras absolutas, e o que constitui aprovação.`}</Prompt>
      ...
      <div className="mt-6 flex justify-between">
        ...
        <Link href="/exercises/5" className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors">
