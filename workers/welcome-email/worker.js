/**
 * AI Builder Camp — Welcome Email Worker
 * Deploy via: Cloudflare Dashboard → Workers → Create Worker → paste this file
 *
 * Required secret (Settings → Variables → Add):
...
function buildEmail(name, company) {
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
        ...
        <tr><td style="background:#ffffff;padding:40px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
            <tr><td style="padding:12px 0;border-top:1px solid #f1f5f9;">
              ...
              <p style="margin:0 0 4px;font-size:14px;font-weight:600;color:#0f172a;">Entenda o poder dos Agentes</p>
              <p style="margin:0;font-size:13px;color:#64748b;line-height:1.5;">6 exercícios práticos — de um produto digital ao briefing semanal automatizado.</p>
            </td></tr>
            <tr><td style="padding:12px 0;border-top:1px solid #f1f5f9;">
              <p style="margin:0 0 2px;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;">Ato II</p>
              <p style="margin:0 0 4px;font-size:14px;font-weight:600;color:#0f172a;">Construa seu primeiro Agente</p>
              <p style="margin:0;font-size:13px;color:#64748b;line-height:1.5;">Agentes autônomos que monitoram mercado, produzem conteúdo e fazem due diligence.</p>
            </td></tr>
            <tr><td style="padding:12px 0;border-top:1px solid #f1f5f9;">
              <p style="margin:0 0 2px;font-size:11px;font-weight:700;color:#94a3b8;text-transform:uppercase;">Ato III</p>
              <p style="margin:0 0 4px;font-size:14px;font-weight:600;color:#0f172a;">Conecte ao mundo real</p>
              <p style="margin:0;font-size:13px;color:#64748b;line-height:1.5;">Agente com busca web, documentos do Drive e Slack — tudo integrado.</p>
            </td></tr>
          </table>
        ...
        <tr><td style="background:#f8fafc;border-radius:0 0 12px 12px;padding:20px 40px;border-top:1px solid #e2e8f0;">
          <p style="margin:0;font-size:12px;color:#94a3b8;text-align:center;">
            Você está recebendo este email porque se cadastrou no AI Builder Camp.${company ? ` Empresa: ${company}.` : ""}
          </p>
        </td></tr>
